    ...
    ?>
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="col-sm-6"><!-- col-sm-6 Begin -->
                             <center><img class="img-responsive" src="admin_area/product_images/apple3.jpg" alt="Product 3-a"></center>
                   ...
                   <div class="col-sm-6"><!-- col-sm-6 Begin -->
                       <div class="box"><!-- box Begin -->
                           <h1 class="text-center" style="color:rgb(79, 191, 168); ">Apple iPhone XS</h1>
                           <p>
                               
                           </p>
                           <form action="details3.php" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                                <br />
                                <div class="clear"></div>
