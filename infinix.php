    ...
    ?>
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="row"><!-- row Begin -->
                   ...
                   <img class="img-responsive" src="admin_area/product_images/infinix3.jpg" alt="Infinix Hot 9"> </a>
                   ...
                   <div class="text"><!-- text Begin -->
                       ...
                       <p class="price">Rs.17,799</p>
                       
                       <p class="button">
                           
                           <a href="details10.php" class="btn btn-default">View Details</a>
                           
                           <a href="details10.php" class="btn btn-primary">
                   ...
                   <img class="img-responsive" src="admin_area/product_images/infinix2.jpg" alt="Infinix Smart 4">
                       </a>
                   ...
                   <div class="text"><!-- text Begin -->
                       ...
                       <p class="price">Rs.14,699</p>
                       
                       <p class="button">
                           
                           <a href="details11.php" class="btn btn-default">View Details</a>
                           
                           <a href="details11.php" class="btn btn-primary">
                   ...
                   <img class="img-responsive" src="admin_area/product_images/Infinix1.jpg" alt="Samsung Galaxy Note 10 Plus">
                   ...
                   <div class="text"><!-- text Begin -->
                       ...
                       <p class="price">Rs. 28,999</p>
                       
                       <p class="button">
                           
                           <a href="details12.php" class="btn btn-default">View Details</a>
                           
                           <a href="details12.php" class="btn btn-primary">
