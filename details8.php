    ...
    ?>
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="col-sm-6"><!-- col-sm-6 Begin -->
                             <center><img class="img-responsive" src="admin_area/product_images/huawei4.jpg" alt="Product 3-a"></center>
                   ...
                   <div class="col-sm-6"><!-- col-sm-6 Begin -->
                       <div class="box"><!-- box Begin -->
                           <h1 class="text-center" style="color:rgb(79, 191, 168); ">Huawei Honor 9x</h1>
                           <p>
