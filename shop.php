    ...
    ?>
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="row"><!-- row Begin -->
                   ...
                   <img class="img-responsive" src="admin_area/product_images/apple1.jpg" alt="Product 1"> </a>
                   ...
                   <div class="text"><!-- text Begin -->
                       ...
                       <p class="price">Rs.228,399</p>
                       
                       <p class="button">
                           
                           <a href="details1.php" class="btn btn-default">View Details</a>
                           
                           <a href="details1.php" class="btn btn-primary">
                   ...
                   <img class="img-responsive" src="admin_area/product_images/apple2.jpg" alt="Samsung Galaxy S10 Lite">
                       </a>
                   
                   <div class="text"><!-- text Begin -->
                       
                       <h3>
                           <a href="details2.php">Apple iPhone XS Maxe
                           </a>
                       </h3>
                       
                       <p class="price">Rs.120,399</p>
                       
                       <p class="button">
                           
                           <a href="details2.php" class="btn btn-default">View Details</a>
                           
                           <a href="details2.php" class="btn btn-primary">
                   ...
                   <a href="details3.php">
                   <img class="img-responsive" src="admin_area/product_images/apple3.jpg" alt="Samsung Galaxy Note 10 Plus">
                   ...
                   <div class="text"><!-- text Begin -->
                       ...
                       <p class="price">Rs.126,999</p>
                       
                       <p class="button">
                           
                           <a href="details3.php" class="btn btn-default">View Details</a>
                           
                           <a href="details3.php" class="btn btn-primary">
