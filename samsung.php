    ...
    ?>
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="row"><!-- row Begin -->
                   ...
                   <img class="img-responsive" src="admin_area/product_images/samsung2.jpg" alt="Product 1"> </a>
                   ...
                   <div class="text"><!-- text Begin -->
                       ...
                       <p class="price">Rs.160,999<</p>
                       
                       <p class="button">
                           
                           <a href="details4.php" class="btn btn-default">View Details</a>
                           
                           <a href="details4.php" class="btn btn-primary">
                   ...
                   <img class="img-responsive" src="admin_area/product_images/samsung3.jpg" alt="Samsung Galaxy S10 Lite">
                       </a>
                   ...
                   <div class="text"><!-- text Begin -->
                       ...
                       <p class="button">
                           ...
                           <a href="details5.php" class="btn btn-default">View Details</a>
                           
                           <a href="details5.php" class="btn btn-primary">
                   ...
                   <a href="details6.php">
                   <img class="img-responsive" src="admin_area/product_images/samsung4.jpg" alt="Samsung Galaxy Note 10 Plus">
                   ...
                   <div class="text"><!-- text Begin -->
                       ...
                       <p class="price">Rs.186,499</p>
                       
                       <p class="button">
                           
                           <a href="details6.php" class="btn btn-default">View Details</a>
                           
                           <a href="details6.php" class="btn btn-primary">
